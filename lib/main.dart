...
class L {
  ...
  String get onboardingClose => pick(ko: '닫기', en: 'Close', ja: '閉じる', vi: 'Đóng');
  String get onboardingHelpMenu => pick(ko: 'Bella 도움말', en: 'Bella Help', ja: 'Bellaヘルプ', vi: 'Trợ giúp Bella');
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  static const String _bannerAdUnitId = 'ca-app-pub-9908025081225328/9987865372';
  ...
  void _loadBannerAd() {
    final banner = BannerAd(
      ...
      listener: BannerAdListener(
        onAdLoaded: (ad) {
          debugPrint('[TickDayAd] Banner loaded');
          if (!mounted) {
            ad.dispose();
            return;
          }
        ...
        onAdFailedToLoad: (ad, error) {
          debugPrint('[TickDayAd] Banner failed: code=${error.code} message=${error.message}');
          ad.dispose();
          if (!mounted) return;
          setState(() {
            _bannerAd = null;
  ...
  Future<void> _showBellaHelp() async {
    if (!mounted) return;
    await Navigator.of(context).push<void>(
      PageRouteBuilder<void>(
        opaque: false,
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text('Version 1.0.5', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Color(0xFF9CA3AF))),
            ),
          ],
        ),
      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _quickMenuTile(
                            ...
                            title: L.of(context).pick(ko: '일반 알림 미리보기', en: 'Normal Alert Preview', ja: '通常通知プレビュー', vi: 'Xem trước thông báo thường'),
                            subtitle: L.of(context).pick(ko: '즉시 테스트 알림 보내기', en: 'Send a test notification instantly', ja: 'テスト通知をすぐ送信', vi: 'Gửi thông báo thử ngay'),
                            onTap: () async {
                              Navigator.of(dialogContext).pop();
                          ...
                          _quickMenuTile(
                            ...
                            title: L.of(context).pick(ko: '강한 알림 미리보기', en: 'Full-Screen Alert Preview', ja: '全画面通知プレビュー', vi: 'Xem trước cảnh báo toàn màn hình'),
                            subtitle: L.of(context).pick(ko: '전체 화면 알림 체험', en: 'Experience full-screen alerts', ja: '全画面通知を体験', vi: 'Trải nghiệm cảnh báo toàn màn hình'),
                            onTap: () async {
                              Navigator.of(dialogContext).pop();
                          ...
                          _quickMenuTile(
                            ...
                            title: L.of(context).pick(ko: '오늘 요약 알림', en: 'Daily Summary Alert', ja: '今日の要約通知', vi: 'Thông báo tóm tắt hôm nay'),
...
class BellaOnboardingScreen extends StatefulWidget {
  final Future<void> Function() onDone;
  /// true: 도움말 모드 (건너뛰기 숨김, 마지막 버튼 "닫기", 플래그 저장 없음)
  /// false: 첫 실행 모드 (건너뛰기 표시, 마지막 버튼 "시작하기")
  final bool isHelpMode;

  const BellaOnboardingScreen({
    super.key,
    required this.onDone,
